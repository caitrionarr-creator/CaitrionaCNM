$pages = @(
    @{ id='clinical-governance'; title='Clinical Governance'; desc='Ensuring standards of care and continuous improvement.'; text='Clinical governance is the framework through which healthcare organizations are accountable for continuously improving the quality of their services and safeguarding high standards of care. In the Cath Lab, this involves rigorous clinical audits, evidence-based practice implementation, risk management, and fostering an environment of continuous learning and accountability.' },
    @{ id='operational-management'; title='Operational Management'; desc='Optimizing day-to-day cath lab workflow and efficiency.'; text='Effective operational management is critical to the daily success of the Cath Lab. This encompasses scheduling, staff allocation, workflow optimization, and ensuring that all equipment is functioning correctly. A focus on operational efficiency minimizes patient wait times, maximizes throughput, and maintains a calm, structured environment for both patients and clinical staff.' },
    ...
    @{ id='resource-control'; title='Resource & Financial Control'; desc='Strategic budget management and resource allocation.'; text='Managing a Cath Lab requires acute financial stewardship and strategic resource allocation. This involves overseeing the budget, managing supply chains, optimizing the use of high-cost consumables, and negotiating with vendors. Sound financial control ensures that the lab remains economically viable while continuing to provide state-of-the-art care to our patients.' },
    @{ id='strategic-development'; title='Strategic Development'; desc='Planning for future growth and technological advancement.'; text='Strategic development involves looking beyond day-to-day operations to plan for the future of the Cath Lab. This includes assessing new cardiovascular technologies, expanding service lines, developing business cases for capital equipment, and aligning the lab’s goals with the broader strategic objectives of the hospital and healthcare system.' },
    @{ id='leadership'; title='Leadership'; desc='Inspiring and guiding multidisciplinary teams.'; text='Leadership in the Cath Lab requires guiding a highly skilled, multidisciplinary team of cardiologists, nurses, radiographers, and physiologists. A strong leader fosters a culture of collaboration, mutual respect, and high performance. By mentoring staff, resolving conflicts, and communicating a clear vision, leadership ensures the team remains motivated and cohesive under pressure.' },
    @{ id='patient-safety'; title='Patient Safety'; desc='Prioritizing safe environments and risk management.'; text='Patient safety is the cornerstone of all Cath Lab activities. This domain focuses on minimizing risks, preventing adverse events, and maintaining a culture where safety is prioritized above all else. From strict adherence to infection control protocols to rigorous pre-procedure checklists and radiation safety, every protocol is designed to protect our patients during complex interventions.' }
)
...
"@
    Set-Content -Path "$($p.id).html" -Value $content
}
